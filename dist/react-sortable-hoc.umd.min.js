!(function(e, t) {
  ...
  var ee = {
      ...
      keyCodes: s.shape({
        lift: s.arrayOf(s.number),
        drop: s.arrayOf(s.number),
        cancel: s.arrayOf(s.number),
        up: s.arrayOf(s.number),
        down: s.arrayOf(s.number),
      }),
    ...
    te = {lift: [U], drop: [U], cancel: [X], up: [q, Y], down: [V, F]},
    ne = {
      axis: 'y',
      disableAutoscroll: !1,
      distance: 0,
  ...
  function ae(t) {
    ...
    return (
      ...
      d(i, [
          ...
          value: function(e) {
            ...
            if (
              ...
              var f = (function(e) {
                ...
                m = this.width / 2 - y.x,
                x = this.height / 2 - y.y;
              (d.x = W(this.minTranslate.x + g, this.maxTranslate.x - m, d.x)),
                (d.y = W(
                  ...
                  ? (t && M(h, t),
                    this.axis.x
                      ? this.axis.y
                        ...
                        ? ((w.x = -(this.width + this.marginOffset.x)),
                          (this.newIndex = p))
                        : (b || (p < this.index && s + i.left <= S.left + m)) &&
                          ((w.x = this.width + this.marginOffset.x),
                          null == this.newIndex && (this.newIndex = p))
                      : this.axis.y &&
                        (x || (p > this.index && l + i.top + v >= S.top)
                          ? ((w.y = -(this.height + this.marginOffset.y)),
                            (this.newIndex = p))
                          : (b || (p < this.index && l + i.top <= S.top + v)) &&
                            ((w.y = this.height + this.marginOffset.y),
                            null == this.newIndex && (this.newIndex = p))),
                    A(h, w),
                    (a[d].translate = w))
        ...
        },
        {
          ...
          value: function() {
            var e = r.withRef ? 'wrappedInstance' : null;
            return a.createElement(t, c({ref: e}, E(this.props, oe)));
          },
        },
        {
          key: 'helperContainer',
    ...
    function i(e) {
      ...
      return (
        u(this, i),
        (b = p(this, y(i).call(this, e))),
        m(h(b), 'state', {}),
        m(h(b), 'handleStart', function(e) {
          var t = b.props,
            n = t.distance,
            o = t.shouldCancelStart;
          if (2 !== e.button && !o(e)) {
            (b.touched = !0), (b.position = K(e));
            var r = j(e.target, function(e) {
              return null != e.sortableInfo;
            });
            if (r && r.sortableInfo && b.nodeIsChild(r) && !b.state.sorting) {
              var i = b.props.useDragHandle,
                a = r.sortableInfo,
                s = a.index,
                l = a.collection;
              if (a.disabled) return;
              if (i && !j(e.target, J)) return;
              (b.manager.active = {collection: l, index: s}),
                (function(e) {
                  return (
                  ...
                  e.preventDefault(),
                n ||
                  (0 === b.props.pressDelay
                    ? b.handlePress(e)
                    : (b.pressTimer = setTimeout(function() {
                        return b.handlePress(e);
                      }, b.props.pressDelay)));
            }
          }
        }),
        m(h(b), 'nodeIsChild', function(e) {
          return e.sortableInfo.manager === b.manager;
        }),
        m(h(b), 'handleMove', function(e) {
          var t = b.props,
            n = t.distance,
            o = t.pressThreshold;
          if (
            ...
            var r = K(e),
              i = {x: b.position.x - r.x, y: b.position.y - r.y},
              a = Math.abs(i.x) + Math.abs(i.y);
            (b.delta = i),
              n || (o && !(o <= a))
                ? n && n <= a && b.manager.isActive() && b.handlePress(e)
                : (clearTimeout(b.cancelTimer),
                  (b.cancelTimer = setTimeout(b.cancel, 0)));
          }
        }),
        m(h(b), 'handleEnd', function() {
          (b.touched = !1), b.cancel();
        }),
        m(h(b), 'cancel', function() {
          var e = b.props.distance;
          b.state.sorting ||
            (e || clearTimeout(b.pressTimer), (b.manager.active = null));
        }),
        m(h(b), 'handlePress', function(x) {
          try {
            var r = b.manager.getActive(),
              e = (function() {
                if (r) {
                  var e = function() {
                      var e = g.sortableInfo.index,
                        t = (function(e) {
                          var t = window.getComputedStyle(e);
                          return {
                        ...
                        n = b.scrollContainer.getBoundingClientRect(),
                        o = d({collection: v, index: e, node: g});
                      if (
                        ((b.node = g),
                        (b.margin = t),
                        (b.width = o.width),
                        (b.height = o.height),
                        (b.marginOffset = {
                          x: b.margin.left + b.margin.right,
                          y: Math.max(b.margin.top, b.margin.bottom),
                        }),
                        (b.boundingClientRect = g.getBoundingClientRect()),
                        (b.containerBoundingRect = n),
                        (b.index = e),
                        (b.newIndex = e),
                        (b.axis = {
                          x: 0 <= u.indexOf('x'),
                        ...
                        (b.offsetEdge = _(g, b.container)),
                        (b.initialOffset = K(
                          m
                            ? ie({}, x, {
                                pageX: b.boundingClientRect.left,
                                pageY: b.boundingClientRect.top,
                              })
                            : x,
                        )),
                        (b.initialScroll = {
                          left: b.scrollContainer.scrollLeft,
                          top: b.scrollContainer.scrollTop,
                        }),
                        (b.initialWindowScroll = {
                          left: b.contentWindow.pageXOffset,
                          top: b.contentWindow.pageYOffset,
                        }),
                        (b.helper = b.helperContainer.appendChild(
                          (function(e) {
                            var t =
                        ...
                        N(b.helper, {
                          ...
                          left: ''.concat(
                            b.boundingClientRect.left - t.left,
                            'px',
                          ),
                          pointerEvents: 'none',
                          position: 'fixed',
                          top: ''.concat(
                            b.boundingClientRect.top - t.top,
                            'px',
                          ),
                        ...
                        var r = y
                            ? {
                                top: 0,
                                left: 0,
                                width: b.contentWindow.innerWidth,
                                height: b.contentWindow.innerHeight,
                              }
                          ...
                          c = a + s;
                        b.axis.x &&
                          ((b.minTranslate.x = a - b.boundingClientRect.left),
                          (b.maxTranslate.x =
                            c - (b.boundingClientRect.left + b.width))),
                          b.axis.y &&
                            ((b.minTranslate.y = i - b.boundingClientRect.top),
                            (b.maxTranslate.y =
                              l - (b.boundingClientRect.top + b.height)));
                      } else
                        b.axis.x &&
                          ((b.minTranslate.x =
                            (y ? 0 : n.left) -
                          ...
                          b.axis.y &&
                            ...
                            (b.maxTranslate.y =
                              (y
                                ? b.contentWindow.innerHeight
                                : n.top + n.height) -
                              b.boundingClientRect.top -
                              b.height / 2));
                      f &&
                        f.split(' ').forEach(function(e) {
                          return b.helper.classList.add(e);
                        }),
                        (b.listenerNode = x.touches ? g : b.contentWindow),
                        m
                          ? (b.listenerNode.addEventListener(
                              'wheel',
                              b.handleKeyEnd,
                              !0,
                            ),
                          ...
                          : (D.move.forEach(function(e) {
                              return b.listenerNode.addEventListener(
                                e,
                                b.handleSortMove,
                                !1,
                              );
                        ...
                        b.setState({sorting: !0, sortingIndex: e}),
                        p &&
                          p(
                            {node: g, index: e, collection: v, isKeySorting: m},
                            x,
                          ),
                        m && b.keyMove(0);
                    },
                    ...
                    g = r.node,
                    v = r.collection,
                    m = b.manager.isKeySorting,
                    o = (function() {
                      if ('function' == typeof n) {
                        b._awaitingUpdateBeforeSortStart = !0;
                        var e = (function(e, t) {
                          try {
                            var n = e();
                          } catch (e) {
                          ...
                          function(e, t) {
                            if (((b._awaitingUpdateBeforeSortStart = !1), e))
                              throw t;
                            return t;
                          },
                        );
        ...
        m(h(b), 'handleSortMove', function(e) {
          var t = b.props.onSortMove;
          'function' == typeof e.preventDefault && e.preventDefault(),
            b.updateHelperPosition(e),
            b.animateNodes(),
            b.autoscroll(),
            t && t(e);
        }),
        m(h(b), 'handleSortEnd', function(e) {
          var t = b.props,
          ...
          b.listenerNode &&
            (a
              ? (b.listenerNode.removeEventListener(
                  'wheel',
                  b.handleKeyEnd,
                  !0,
                ),
                ...
                b.listenerNode.removeEventListener('keydown', b.handleKeyDown))
              : (D.move.forEach(function(e) {
                  return b.listenerNode.removeEventListener(
                    e,
                    b.handleSortMove,
                  );
                }),
                D.end.forEach(function(e) {
                  return b.listenerNode.removeEventListener(e, b.handleSortEnd);
                }))),
            b.helper.parentNode.removeChild(b.helper),
            n &&
              b.sortableGhost &&
              N(b.sortableGhost, {opacity: '', visibility: ''});
          ...
          b.autoScroller.clear(),
            (b.manager.active = null),
            (b.manager.isKeySorting = !1),
            b.setState({sorting: !1, sortingIndex: null}),
            'function' == typeof o &&
              o(
                {
                  collection: i,
        ...
        m(h(b), 'autoscroll', function() {
          var e = b.props.disableAutoscroll,
            t = b.manager.isKeySorting;
          if (e) b.autoScroller.clear();
          else {
            if (t) {
              var n = ie({}, b.translate),
                o = 0,
                r = 0;
              return (
                b.axis.x &&
                  ((n.x = Math.min(
                    b.maxTranslate.x,
                    Math.max(b.minTranslate.x, b.translate.x),
                  )),
                  (o = b.translate.x - n.x)),
                b.axis.y &&
                  ((n.y = Math.min(
                    b.maxTranslate.y,
                    Math.max(b.minTranslate.y, b.translate.y),
                  )),
                  (r = b.translate.y - n.y)),
                (b.translate = n),
                A(b.helper, b.translate),
                (b.scrollContainer.scrollLeft += o),
                void (b.scrollContainer.scrollTop += r)
              );
            }
            b.autoScroller.update({
              height: b.height,
              maxTranslate: b.maxTranslate,
        ...
        m(h(b), 'onAutoScroll', function(e) {
          (b.translate.x += e.left), (b.translate.y += e.top), b.animateNodes();
        }),
        m(h(b), 'handleKeyDown', function(e) {
          var t = e.keyCode,
            n = b.props,
            o = n.shouldCancelStart,
            r = n.keyCodes,
            i = ie({}, te, {}, void 0 === r ? {} : r);
          (b.manager.active && !b.manager.isKeySorting) ||
            !(
              b.manager.active ||
              (i.lift.includes(t) && !o(e) && b.isValidSortingTarget(e))
            ) ||
            (e.stopPropagation(),
            e.preventDefault(),
            i.lift.includes(t) && !b.manager.active
              ? b.keyLift(e)
              : i.drop.includes(t) && b.manager.active
              ? b.keyDrop(e)
              : i.cancel.includes(t)
              ? ((b.newIndex = b.manager.active.index), b.keyDrop(e))
              : i.up.includes(t)
              ? b.keyMove(-1)
              : i.down.includes(t) && b.keyMove(1));
        }),
        m(h(b), 'keyLift', function(e) {
          var t = e.target,
            n = j(t, function(e) {
              return null != e.sortableInfo;
            }).sortableInfo,
            o = n.index,
            r = n.collection;
          (b.initialFocusedNode = t),
            (b.manager.isKeySorting = !0),
            (b.manager.active = {index: o, collection: r}),
            b.handlePress(e);
        }),
        m(h(b), 'keyMove', function(e) {
          var t = b.manager.getOrderedRefs(),
            n = t[t.length - 1].node.sortableInfo.index,
            o = b.newIndex + e,
            r = b.newIndex;
          if (!(o < 0 || n < o)) {
            (b.prevIndex = r), (b.newIndex = o);
            var i = (function(e, t, n) {
                return e < n && t < e ? e - 1 : n < e && e < t ? e + 1 : e;
              })(b.newIndex, b.prevIndex, b.index),
              a = t.find(function(e) {
                return e.node.sortableInfo.index === i;
              }),
              s = a.node,
              l = b.containerScrollDelta,
              c = a.boundingClientRect || H(s, l),
              u = a.translate || {x: 0, y: 0},
              d = c.top + u.y - l.top,
              f = c.left + u.x - l.left,
              h = r < o,
              p = h && b.axis.x ? s.offsetWidth - b.width : 0,
              y = h && b.axis.y ? s.offsetHeight - b.height : 0;
            b.handleSortMove({
              pageX: f + p,
              pageY: d + y,
        ...
        m(h(b), 'keyDrop', function(e) {
          b.handleSortEnd(e),
            b.initialFocusedNode && b.initialFocusedNode.focus();
        }),
        m(h(b), 'handleKeyEnd', function(e) {
          b.manager.active && b.keyDrop(e);
        }),
        m(h(b), 'isValidSortingTarget', function(e) {
          var t = b.props.useDragHandle,
            n = e.target,
            o = j(n, function(e) {
              return null != e.sortableInfo;
            });
    ...
    return (
      ...
      d(i, [
        ...
        },
        {
          ...
          value: function() {
            var e = r.withRef ? 'wrappedInstance' : null;
            return a.createElement(t, c({ref: e}, E(this.props, le)));
          },
        },
      ]),
      (n = e = i),
  ...
  (e.SortableContainer = ae),
    (e.SortableElement = ce),
    (e.SortableHandle = $),
